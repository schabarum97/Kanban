            ...
            <template v-slot:body="props">
              <q-tr :props="props">
                ...
                <q-td class="action-buttons">
                  <q-btn label="Editar" color="black" @click="editProject(props.row)" size="sm" />
                  <q-btn label="Excluir" color="red" @click="deleteProject(props.row.prj_id)" size="sm" />
                </q-td>
              </q-tr>
            </template>
          </q-table>
...
export default {
  ...
  methods: {
    ...
    async deleteProject(projectId) {
      try {
        await Projeto.deleteProjeto(projectId);
        this.q.notify({
          type: 'positive',
